...
window.GIF_API_KEY = localStorage.getItem('GIF_API_KEY') || localStorage.getItem('TENOR_API_KEY') || 'DUMMY';
window.TENOR_API_KEY = window.GIF_API_KEY; // Backward compatibility alias
